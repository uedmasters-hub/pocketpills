        ...
        <div ref={treatRef} className="pp-scroll flex gap-4 overflow-x-auto pb-1">
          {treatments.map((t) => (
            <button
              ...
              className="pp-snap relative flex aspect-[4/5] w-[13.5rem] shrink-0 flex-col overflow-hidden rounded-[20px] text-left transition-transform hover:-translate-y-0.5"
