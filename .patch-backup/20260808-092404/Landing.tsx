...
function Hero() {
  ...
  return (
    <section className="relative -mt-[65px] h-[560px] overflow-hidden bg-[color:var(--pp-lavender)] sm:h-[660px] md:-mt-[82px]">
      ...
      {HERO.file ? (
        ...
        <iframe
          ...
          className={
            "pointer-events-none absolute left-1/2 top-1/2 h-full w-[250%] -translate-x-1/2 -translate-y-1/2 transition-opacity duration-700 sm:h-[132%] sm:w-full " +
      ...
      <button
        onClick={toggle}
        className="absolute bottom-4 left-1/2 z-20 grid h-9 w-9 -translate-x-1/2 place-items-center rounded-full bg-black/30 text-[11px] text-white backdrop-blur transition-colors hover:bg-black/50 sm:bottom-auto sm:left-auto sm:right-5 sm:top-24 sm:translate-x-0"
