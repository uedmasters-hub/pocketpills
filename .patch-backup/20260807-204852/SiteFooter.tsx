      ...
      <div className="flex flex-col gap-10 rounded-[20px] bg-[color:var(--pp-primary-200)] px-3 py-8 md:rounded-[28px] md:p-12">
        ...
        <div className="flex flex-col-reverse items-start justify-between gap-6 sm:flex-row">
          <div className="flex flex-col items-start gap-2">
            <Social />
            <div className="flex items-center gap-1.5 text-[13px] text-[color:var(--pp-primary-950)]">
              <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden><circle cx="12" cy="12" r="10" /><path d="M14.83 14.83a4 4 0 1 1 0-5.66" /></svg>
              <p>2026 Pocketpills</p>
            </div>
            <div className="flex flex-wrap items-center text-[13px] text-[color:var(--pp-primary-950)]">
            ...
            <div className="mt-2 flex items-center gap-4">
              <button className="flex items-center gap-6 rounded-lg border border-line bg-[color:var(--pp-primary-100)] px-3 py-2 text-[13px] text-ink-secondary">
                EN <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden><path d="m6 9 6 6 6-6" /></svg>
              </button>
              <div className="text-[12px] text-ink-tertiary"><p>Pocketpills is not a pharmacy</p><p>or a drug manufacturer</p></div>
            </div>
          </div>

          <div className="flex flex-col gap-3">
            <h3 className="text-center text-[11px] font-semibold uppercase tracking-[0.12em] text-ink-tertiary">Certifications</h3>
            <div className="flex items-center gap-3">
              <img loading="lazy" onError={hideOnError} src={`${CDN}/images/landing/footer/legitScript_logo.png`} width={60} height={60} alt="LegitScript approved" />
              <img loading="lazy" onError={hideOnError} src="https://static.pocketpills.com/webapp/rebrand/landing/logo_soc2.webp" width={70} height={70} className="h-[70px]" alt="SOC 2 certification" />
            </div>
          </div>
        </div>
      </div>
