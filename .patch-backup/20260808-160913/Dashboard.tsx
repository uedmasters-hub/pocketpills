...
function PromoCard({ p, onClick }: { p: Promo; onClick: () => void }) {
  return (
    <button
      onClick={onClick}
      className="pp-snap flex min-h-[15rem] w-[86%] flex-none items-stretch gap-4 overflow-hidden rounded-2xl bg-[color:var(--pp-primary-200)] p-4 text-left sm:w-[68%] sm:p-5"
    >
