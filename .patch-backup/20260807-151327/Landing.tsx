        ...
        <div>
          ...
          <div className="relative flex min-h-[190px] items-center overflow-hidden rounded-2xl p-7 text-white"
            ...
            <div className="relative z-10">
              ...
              <button onClick={() => go("/drug/ozempic")} className="mt-5 inline-flex items-center gap-1.5 rounded-full bg-white px-4 py-2 text-xs font-semibold text-[color:var(--pp-navy)]">
...
function FeatureCards({ go }: { go: (to?: string) => void }) {
  const cards = [
    ...
    { t: "Get a Sildenafil prescription.", cta: "Learn more", bg: "bg-[color:var(--pp-violet-mid)] text-white", fg: "text-white", to: "/find-care", art: "dots" },
  ...
  return (
    <section className="mx-auto w-full max-w-[1280px] px-5 pt-6 sm:px-8">
