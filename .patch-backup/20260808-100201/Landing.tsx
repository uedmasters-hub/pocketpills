...
function Hero() {
  ...
  return (
    ...
    >
      ...
      {/* corner labels */}
      <div className="pointer-events-none absolute inset-x-0 bottom-24 z-30 mx-auto flex w-full max-w-[105rem] flex-wrap items-center justify-between gap-3 px-5 md:px-8 xl:px-20">
