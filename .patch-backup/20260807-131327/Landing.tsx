...
function Header() {
  ...
  return (
    <div className="sticky top-3 z-40 px-3 sm:px-4">
      <div
        className="mx-auto flex h-14 max-w-[1560px] items-center justify-between gap-4 rounded-2xl px-4 backdrop-blur-md sm:px-6"
      ...
      >
        ...
        <nav className="hidden items-center gap-6 lg:flex" onMouseLeave={() => setOpen(null)}>
          {Object.keys(MENUS).map((m) => (
            <div key={m} className="relative" onMouseEnter={() => setOpen(m)}>
              <button className="flex items-center gap-1.5 py-2 text-[13px] font-medium text-[#4b4560] hover:text-[color:var(--pp-navy)]" aria-expanded={open === m}>
        ...
        <div className="flex items-center gap-4">
          {signedIn ? (
            ...
            <>
              <Link to="/login" className="hidden items-center gap-1.5 text-[13px] font-medium text-[#4b4560] hover:text-[color:var(--pp-navy)] sm:inline-flex">
...
function Hero() {
  ...
  return (
    <section className="relative -mt-[68px] h-[560px] overflow-hidden bg-[color:var(--pp-lavender)] sm:h-[660px]">
      ...
      {/* corner labels */}
      <div className="absolute inset-x-0 bottom-5 z-10 mx-auto flex max-w-[1560px] flex-wrap items-center justify-between gap-2 px-6 text-[11px] font-medium text-[color:var(--pp-navy)] sm:px-10">
...
function Welcome({ onStart }: { onStart: () => void }) {
  ...
  return (
    <section className="relative z-20 -mt-16 px-6 sm:px-14">
      <div className="mx-auto max-w-[1400px] rounded-t-[28px] bg-surface-2 px-6 pb-12 pt-9 text-center sm:px-12">
